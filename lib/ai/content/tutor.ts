...
const models = [...new Set([process.env.GEMINI_TUTOR_MODEL, "gemini-flash-latest", "gemini-3.5-flash-lite", "gemini-3.1-flash-lite"].filter((value): value is string => Boolean(value)))];
