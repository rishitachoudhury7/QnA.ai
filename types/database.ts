...
export type VideoSegment = { id: string; resource_id: string; start_seconds: number; end_seconds: number; text: string; created_at: string };
...
export type VideoSegmentInsert = Pick<VideoSegment, "resource_id" | "start_seconds" | "end_seconds" | "text">;
